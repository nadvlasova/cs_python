...
class ClientTransport(threading.Thread, QObject):
    ...
    # Функция закрытия соединения, отправляет сообщение о выходе клиента.
