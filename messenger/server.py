...
def main():
    ...
    # Функция обновляющая список подключенных, проверяет флаг подключения и если нужно обновляет список.
    def list_update():
        global new_connection
        if new_connection:
    ...
    # Функция создающая окно со статикой клиентов.
    def show_statistics():
        global stat_window
    ...
    def server_config():
        ...
        # Создаем окно и вносим в него текущие параметры.
