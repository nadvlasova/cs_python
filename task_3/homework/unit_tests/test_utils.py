...
from task_3.homework.common.utils import send_message, get_message
from task_3.homework.common.variables import ENCODING, ACTION, PRESENCE, USER, TIME, ACCOUNT_NAME, RESPONSE, ERROR
