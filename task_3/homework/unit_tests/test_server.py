...
# В сервере только одна функция для тестирования - ?????
import unitest

from task_3.homework.common.variables import RESPONSE, ERROR, TIME, USER, ACCOUNT_NAME, ACTION, PRESENCE
from task_3.homework.server import process_client_message
